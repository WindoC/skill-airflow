...
- API base: `https://airflow.example.com/api/v1`
...
Important: Airflow authentication is backend-dependent at runtime. The spec lists available schemes, but the active auth method on your server (`https://airflow.example.com`) depends on Airflow configuration.
